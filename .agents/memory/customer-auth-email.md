...
**Why:** overwriting account A's email to onboard person B hands B the original owner's account — their phone, loyalty, wash history, and active session. It also silently deletes A's only login path. (Hit this live: renaming jannahjumat's account to jannahzamari hijacked the real Jumat; fix required restoring 469→Jumat+her car and minting a fresh account for Zamari.)
