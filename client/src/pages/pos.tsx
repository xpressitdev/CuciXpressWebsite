...
import {
  InteriorRefreshPosButton,
  InteriorRefreshTodayReminder,
} from "@/components/admin/InteriorRefreshPosControl";
import {
  Dialog,
  DialogContent,
  DialogDescription,
        ...
        <div className="max-w-6xl mx-auto px-4 space-y-6">
          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {staff && staff.role !== "lane" && <InteriorRefreshPosButton />}
              <button
                onClick={logout}
                className="cuci-cta bg-white text-gray-900 px-4 py-2 rounded-full inline-flex items-center gap-2 text-sm"
          ...
          {staff && <InteriorRefreshTodayReminder />}
